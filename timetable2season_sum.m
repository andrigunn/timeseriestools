...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.ONDJFMA.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.SON.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.MJJA.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.MJJAS.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.AM.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.DJF.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
...
% Mánaðarmeðaltöl
oTTable.mM = retime(iTable,'monthly','sum');

% Ársmeðaltöl
oTTable.mY = retime(iTable,'yearly','sum');
...
for ii = 1:length(vars)
    ...
    for i = 1:length(uqy)
        ...
        oTable.hY.(string(var))(i) = sum(iTable.(string(var))(tr,:));
    end
end
